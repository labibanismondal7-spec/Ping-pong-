...
- Voice room: 12-সিট, WebRTC/SFU-ready voice, real-time mic-level ভিত্তিক speaking-ring (শুধু "বসে থাকা" না, আসলেই কথা বললে জ্বলে)
...
- ওয়ালেট (Diamonds + Beans, exchange request), ডেইলি/উইকলি ট্রেজার বক্স
...
- সম্পূর্ণ Admin Panel: user ban/verify/diamond/wallet controls, room lock/delete, exchange approve/reject, frame upload, agency তৈরি, chest level কনফিগ
- পুরো UI Gold + Black + Royal থিমে

## Current production scope
The release package is intended to keep the currently implemented PingPong feature set intact while hardening runtime, wallet, room, game, admin, and Android WebView paths. No user data or custom assets are intentionally removed by the cleanup process.
